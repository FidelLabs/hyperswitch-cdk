...
echo "1. Ensure CodeBuild completed successfully (check above)"
echo "2. Verify all ECR repositories exist (check above)"
echo "3. Check node IAM role has ECR read permission (check above)"
echo "4. Manually pull image to test:"
echo "   kubectl run test --image=$ACCOUNT_ID.dkr.ecr.$REGION.amazonaws.com/grafana/grafana --rm -it --restart=Never"
echo ""
echo "5. Check pod events:"
echo "   kubectl describe pod <POD_NAME> -n <NAMESPACE>"
echo ""
echo "6. Force delete and recreate pod:"
